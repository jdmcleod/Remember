    ...
    class Importer
      def self.import
        ...
        users_to_import.find_each.with_index do |user, user_index|
          ...
          # TODO: filter out days past today
          days_to_import = user.days.where.missing(:be_real_memories)
          ...
          days_to_import.find_each.with_index do |day, day_index|
            ...
            memory_data = user.be_real_connection.memories_for_date(day.date)
            ...
            memory_data.each do |raw_memory|
              ...
              new_memory.attach_image_from(raw_memory.primary.url, :secondary)
              new_memory.attach_image_from(raw_memory.primary.url, :thumbnail)
